        ...
        <Box className='flex flex-col items-center gap-6'>
          <div className='flex gap-8 mb-4'>
            ...
            >
              <img
                src={reactLogo}
                className='h-24 w-24 animate-spin-slow hover:drop-shadow-lg transition-all'
                alt='React logo'
              />
            </a>
          </div>
        ...
        >
          <Box className='p-4'>
            ...
            <Typography variant='body1' className='mb-4'>
              This modal is loaded from FLow-Project-UIVisual using Module
              Federation. It's fully functional with drag, resize, screenshot,
