...
import {
    deleteAtom, nodeConfigAtom, selectedEdgeIdAtom, selectedNodeIdAtom, selectedPageAtom, updateConfigAtom, subComponentListAtom,
...
import { extractColorsFromSvg, text_box_resources } from '../../../../utills/flowUtills/FlowUtills'
import { isSpecialNode } from '../../utils/nodeSpecialHandling/NodeSpecialHandling'
import { svgMap } from '../svgMap/SvgMap'
import { renderColorField, renderGradientColorField, renderNumberField, renderStrokeColorField, renderSubSystemSelect, renderTextField } from './NodeConfigurator.function'
...
const NodeConfigurator = () => {
    ...
    const getInputField = (field, data) => {
        ...
        switch (field.type) {
            ...
            case "gradientColor":
                return renderGradientColorField(field, data, onConfigChange, extractedColors);
            case "select":
