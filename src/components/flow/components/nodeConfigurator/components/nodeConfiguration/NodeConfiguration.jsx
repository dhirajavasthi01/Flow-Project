    ...
    <div className='h-100'>
                 ...
                 <div className='p-[1vmin_1.5vmin]'>
                     <p className="text-14 text-primary_gray font-sabic_text_bold uppercase mb-1">
                         Node id :{' '}
                         <span className="text-14 font-sabic_text_regular text-primary_gray_1">{config.id}</span>
                     </p>
                 ...
                 <>
                     ...
                     <div className="text-14 text_primary_gray_3 uppercase p-[1.5vmin_1.5vmin]">
                         <b className=''>Note :  </b> All changes to the node will only be applied upon clicking
                         Apply button
                     </div>
                 </>
             </div>
