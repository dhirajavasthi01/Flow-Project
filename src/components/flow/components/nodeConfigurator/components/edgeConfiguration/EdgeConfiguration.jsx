  ...
  return (
    <div className='h-100'>
             <div className='flex justify-between items-center bg-primary_blue_bg p-[1.5vmin]  border-b-[0.025vmin] border-b-primary_gray_3 '>
                 <h3 className="text-14 text-primary_dark_blue uppercase font-sabic_text_bold">Configure Node</h3>
             </div>
             <p className="text-14 p-[1vmin_1.5vmin] text-primary_gray uppercase font-sabic_text_bold">
                 Edge id : <span className="ml-1 text-12 text-primary_gray_2 break-keep font-sabic_text_regular">{config.id}</span>
             </p>
             <div className='p-[1vmin_1.5vmin] flex items-center whitespace-nowrap'>
                 <label className="text-14 text-primary_gray font-sabic_text_bold uppercase mr-1">Edge Type : </label>
                 <select
             ...
             <div className='p-[1vmin_1.5vmin] flex items-center whitespace-nowrap'>
                 <label className="text-14 text-primary_gray font-sabic_text_bold uppercase mr-1">Edge Color : </label>
                 <input
                     type="color"
                     name="strokeColor"
             ...
             <div className='p-[1vmin_1.5vmin] flex items-center whitespace-nowrap'>
                 <label className="text-14 text-primary_gray font-sabic_text_bold uppercase mr-1">Edge Width : </label>
                 <input
                     type="number"
                     name="strokeWidth"
                     min="1"
             ...
             {config?.markerEnd && (
                 <div className='p-[1vmin_1.5vmin] flex items-center whitespace-nowrap'>
                     <label className="text-14 text-primary_gray font-sabic_text_bold uppercase mr-1">Arrow Size : </label>
                     <input
                         type="number"
                         name="arrowSize"
                         min="5"
             ...
             <div className="flex justify-around p-[0vmin_1.5vmin] items-center mt-[1vmin] flex-wrap gap-[1vmin]">
                 ...
                 <button
                     className={
                         `bg-primary_black hover:bg-primary_gray text-14 rounded-[0.3vmin] text-white p-[0.9vmin_2vmin] uppercase`}
