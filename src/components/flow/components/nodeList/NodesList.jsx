...
import { allNodes } from '../../utils/nodeEdgeType/NodeEdgeType'
...
const NodesList = () => {
  ...
  return (
    <div className='sticky top-0 overflow-y-auto max-h-[37.9vmin] border-b-[0.025vmin] border-b-primary_gray_3'>
      <div
        className={`sticky top-0 flex justify-between items-center bg-primary_blue_bg p-[1.5vmin] ${!isCollapsible ? '' : 'border-b-[0.025vmin] border-b-primary_gray_3'}`}
      >
              ...
              return (
                ...
                >
                  {svgMap[node?.nodeType] ? (
                    ...
                    <div className='h-full text-18 text-primary_gray font-sabic_text_bold flex items-center justify-center'>
                      {node.name}
                    </div>
                  )}
                </div>
