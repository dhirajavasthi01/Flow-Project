...
const TemplateSidebar = () => {
  ...
  return (
    <div>
      <div className='flex justify-between items-center bg-primary_blue_bg p-[1.5vmin]  border-b-[0.025vmin] border-primary_gray_3'>
          ...
          {templates.length === 0 ? (
            ...
            <div className='flex flex-col gap-2'>
              {templates.map((template) => (
                <div
                  key={template.id}
                  className={`relative group bg-white border border-gray-300 rounded-md p-3 cursor-grab transition-all duration-200 shadow-sm hover:border-[#009FDF] hover:shadow-md hover:-translate-y-[1px] ${
