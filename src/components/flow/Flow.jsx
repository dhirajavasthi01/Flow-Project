...
import { absoluteToRelative, getDescendantIds, isPointInNode, relativeToAbsolute, wouldCreateCircularDependency, findGroupNodeAtPoint, sortNodesByParentChild } from './utils/parentChildUtils/ParentChildUtils';
...
function Flow(props) {
    ...
    useEffect(() => {
        ...
        handleFetchedNodesEdgesChange({
            ...
            zoomTo,
            fitView,
            getNodes, // Pass getNodes to access current nodes
        });
    ...
    useEffect(() => {
        ...
        handleTableDataChange({ tableData, isDeveloperMode, originalFetchedNodesRef, lastProcessedTableDataRef, processNodesWithTableDataRef, setNodes, getNodes });
