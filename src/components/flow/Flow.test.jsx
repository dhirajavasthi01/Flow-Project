...
describe('Flow Component', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(FlowNodeUtills.shouldNodeBlink).mockReturnValue({ shouldBlink: false });
  });
  afterEach(() => {
    vi.restoreAllMocks();
  });
  describe('Component Rendering', () => {
    ...
    it('should render loader when flow data is loading', () => {
      vi.mocked(useFlowData).mockReturnValue({ ...mockFlowData, isLoading: true });
      renderWithProviders();
    });
  ...
  describe('Node Operations', () => {
    ...
    it('should handle node click when failure mode exists', async () => {
      vi.mocked(FlowNodeUtills.hasSubComponentAssetIdMatch).mockReturnValue(true);
    ...
    it('should process nodes with table data', async () => {
      vi.mocked(FlowNodeUtills.hasSubComponentAssetIdMatch).mockReturnValue(true);
      vi.mocked(FlowNodeUtills.shouldNodeBlink).mockReturnValue({ shouldBlink: true });
  ...
  describe('Template Operations', () => {
    ...
    it('should save template when button clicked with valid input', async () => {
      ...
      const { useFlowSelection } = await import('./hooks/useFlowSelection/useFlowSelection');
  ...
  describe('Background Panel', () => {
    ...
    it('should not show failure mode message in developer mode', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByText(/HOVER OVER THE RED-COLORED OBJECT/i)).not.toBeInTheDocument();
      });
    });
  });
