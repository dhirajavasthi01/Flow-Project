  ...
  const processSvg = (
    ...
    try {
      ...
      if (gradientStart && gradientEnd) {
        ...
        stop1.setAttribute("stop-color", gEnd);
        ...
        stop2.setAttribute("stop-color", gStart);
        ...
        stop3.setAttribute("stop-color", gEnd);
          ...
          (<div className="tooltip_container text-left text-white p-2">
            ...
            <p className="text-12-primary  text-white font-bold">
              ...
              <span className="text-12-primary  text-white">
                ...
                MP HIGH THRUST BEARING TEMPERATURE VARNISH FORMATION OR ACTIVE SIDE

                INTERNAL OIL INJECTION TO PADS AFFECTED
