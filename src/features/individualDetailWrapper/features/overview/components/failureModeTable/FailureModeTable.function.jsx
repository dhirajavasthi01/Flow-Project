...
export const getColumns = (onSubSystemModalClick, onAnomalyIndexModalClick, onTimeEstimationModalClick, onParameterTrendModalClick) => {
  ...
  return [

    {
        ...
        return (
          ...
          <div className='px-1 flex justify-between w-full items-center'>
            ...
            <div>{getValue()}</div>
                ...
                <InfoIcon onClick={() => onSubSystemModalClick(row.original)} className="cursor-pointer h-[2vmin] w-[2vmin]" />
      ...
      meta: {
        ...
        headerClass: 'font-sabic_text_regulat text-14 uppercase w-[8vmin] text-left',
...

    {
      ...
      header: () => {
        ...
        return (
          ...
          <div className='relative font-sabic_text_bold text-12 flex flex-col items-center gap-1 text-center uppercase'>
            ...
            <span className="text-10 absolute bottom-[-1.5vmin] text-primary_gray_18">{`(CHANGE)`}</span>
      ...
      cell: ({ getValue, row }) => {
        ...
        return (
          ...
          <div className='px-1 flex justify-center gap-1 w-full items-center'>
            ...
            <TrendingUpIcon className="cursor-pointer h-[3vmin] w-[3vmin]" onClick={() => onAnomalyIndexModalClick(row?.original)} />
      ...
      meta: {
        ...
        headerClass: 'font-sabic_text_regulat text-12 uppercase w-[8vmin] text-center',
...

    {
      ...
      meta: {
        ...
        headerClass: 'font-sabic_text_regulat text-12 uppercase w-[15vmin] text-left',
...

    {
        ...
        return (
          ...
          <div className="flex justify-between items-center">
            ...
            <div className='px-1 flex flex-col text-left gap-1'>
              ...
              <div className="uppercase text-primary_gray_2">ACTIVE SINCE: {row?.original?.activeSince}</div>

            </div>

            <TrendingUpIcon onClick={() => onParameterTrendModalClick(row?.original)} className="h-[3vmin] w-[3vmin] cursor-pointer" />
      ...
      meta: {
        ...
        headerClass: 'font-sabic_text_regulat text-11 uppercase w-[15vmin] text-left',
        ...
        return (
          ...
          <div className='px-1'>
            ...
            {isLong ? <Tooltip
              ...
              <div>{value.slice(0, 150)} <span className="underline text-primary_blue">...MORE</span></div>
...

    {
      ...
      cell: ({ getValue, row }) => {
        ...
        return (
          ...
          <div className='px-1 flex justify-center gap-1 w-full items-center'>
            ...
            <BarChartIcon className="cursor-pointer icon-img" onClick={() => onTimeEstimationModalClick(row?.original)} />
      ...
      meta: {
        ...
        headerClass: 'font-sabic_text_regulat text-11 uppercase w-[3vmin] text-left',
...
export function computeRowSpanForColumn(
  ...
  while (i < rows.length) {
    ...
    for (let j = i + 1; j < rows.length; j++) {
      ...
      if (rows[j].getValue(columnId) === currentValue) {
    ...
    // Mark first row of group

    spanMap.set(currentRow.id, { rowSpan: count, isFirst: true })

    // Mark other rows in the group as "skip"
